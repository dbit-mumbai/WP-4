...
$write=mysqli_query($connect,"INSERT INTO csireg (fname,mname,lname,dob,gen,num,em,ct,dept,yr,id,sls) values('$fn','$mn','$ln','$dob','$gen','$contact','$em',
	'$city','$dept','$yr','$id','$skl')")or die("error cannot write data into database");
...
<head>
	<link href = "csilogo.jpg" rel="icon" type="image/jpg">
...
<center style="
    ...
    background: -webkit-linear-gradient(left top, blue, powderblue); /* For Safari 5.1 to 6.0 */
    background: -o-linear-gradient(bottom right, blue, powderblue); /* For Opera 11.1 to 12.0 */
    background: -moz-linear-gradient(bottom right, blue, powderblue); /* For Firefox 3.6 to 15 */
    background: linear-gradient(to bottom right, blue, powderblue); /* Standard syntax (must be last) */ }">
<table>
...
<td><img src="csilogo.jpg" alt="CSI LOGO" style="width: 75px;height: 75px;"></td>
